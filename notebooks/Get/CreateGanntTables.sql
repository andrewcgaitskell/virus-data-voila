...
(
    ...
    prev_name text COLLATE pg_catalog."default",
    prev_category text COLLATE pg_catalog."default",
    prev_activity text COLLATE pg_catalog."default",
    prev_date text COLLATE pg_catalog."default",

...
SELECT l."LSOA11CD" as code, ST_Union(l.valid_geom) as geometry into public.poly_lsoa
...
SELECT l."CTRY11CD" as code, ST_Union(l.valid_geom) as geometry into public.poly_ctry
	FROM public.data_ew_lsoapolys l
	group by l."CTRY11CD";
